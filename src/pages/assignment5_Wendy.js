...
function AirlineRoutes(){
    ...
    return <Container >
        ...
        <Col lg={4}>
            <h2>Airlines</h2>
            <svg className={styles.svgStyle} id={"barchart"} width={barchart_width+barchart_margin.right} height={barchart_height}>
        ...
        <Col lg={4} >
            ...
            <svg className={styles.svgStyle} id={"map"} width={map_width} height={map_height}>
                <AirportMap width={map_width} height={map_height} 
                    countries={map} airports={airports} routes={filteredRoutes}
